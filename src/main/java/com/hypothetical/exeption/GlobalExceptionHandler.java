...
import static com.hypothetical.exeption.ErrorType.INVALID_PARAMETER_ERROR;
import static org.springframework.core.Ordered.HIGHEST_PRECEDENCE;
import static org.springframework.http.HttpStatus.INTERNAL_SERVER_ERROR;

import com.hypothetical.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler(HypotheticalException.class)
  @Order(HIGHEST_PRECEDENCE)
  @ResponseBody
  public ResponseEntity<ErrorResponse> handleAdapterException(
      HypotheticalException exception) {
